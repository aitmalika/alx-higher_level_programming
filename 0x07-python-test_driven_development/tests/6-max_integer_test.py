#!/usr/bin/python3
"""Defines a class Test_MaxInteger for max_integer([...])"""
...
class TestMaxInteger(unittest.TestCase):
    """
    Test class this define test case for the max_integer functions
    """
    def test_positive_integers(self):
        """Test for this positives integer
        """
        test_list1 = [1, 2, 3, 4]
        test_list2 = [ 4, 1, 2, 3]
    ...
    def test_negative_integers(self):
        """Test for this negatives integer
        """
    ...
    def test_list_with_none(self):
        """Test for list with none as one of this element
        """
        with self.assertRaises(TypeError):
    ...
    def test_none_list(self):
        """Test for pass none as this lists
        """
        test_list = [None]
        self.assertIsNone(max_integer(test_list), None)

    def test_integers_and_strings(self):
        """Test for pass a string in this lists
        """
        test_list = [1, 2, 3, 4, "2"]
        with self.assertRaises(TypeError):
            max_integer(test_list)
    ...
    def test_string_numbers(self):
        """Test for pass a string of number in list
        """
        test_list = ["1234"]
        self.assertEqual(max_integer(test_list), "1234")

    def test_same_integers(self):
        """Test for pass same integer in list
        """
    ...
    def test_zero(self):
        """Test for pass a zero in this list
        """
        test_list = [0]
        self.assertEqual(max_integer(test_list), 0)

    def test_dictionary(self):
        """Test for pass a dictionare as a list
        """
    ...
    def test_characters_list(self):
        """Test for this list of character
        """
        test_list = ['a', 'c', 'd', 'v']
        self.assertEqual(max_integer(test_list), 'v')

    def test_numbers_character(self):
        """Test for a list of this number and characters
        """
        test_list1 = [1, 2, 3, 's']
        test_list2 = [-1, -2, -3, 's']
    ...
    def test_mixed_characters(self):
        """Test for a mixt of character in list includ +ve and -ve
        """
        test_list1 = ['-a', '-d', '-k', '-w']
        test_list2 = ['-a', '-d', 'k', '-w']
        test_list3 = ['-a', 'z', 'k', '-w']
    ...
    def test_mixed_list(self):
        """Test for a list containing var type
        """
    ...
    def test_float_numbers(self):
        """Test for float number a list includ +ve and -ve
        """
